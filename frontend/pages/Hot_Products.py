...
from frontend.controller.recommendations import get_recommendations
from frontend.utils.config import hide_image_fullscreen, make_sidebar


async def hot_products() -> None:
    """Hot products page."""
    st.set_page_config(
        layout="wide",
        page_icon="🔥",
    ...
    with st.spinner("Loading the product list..."):
        products_json = await get_recommendations(username)
